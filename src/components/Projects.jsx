  ...
  const projects = [
    {
      ...
      description: "An innovative chat application designed specifically for visually impaired users, featuring speech-to-text, text-to-speech, emergency calling, and gesture-based navigation.",
      features: ["MVVM Architecture", "Speech Recognition", "Firebase Integration", "Biometric Auth"],
      stats: [
        { number: "40%", label: "Faster Development" },
        { number: "50%", label: "User Engagement" }
      ],
      technologies: ["Kotlin", "MVVM", "Firebase", "Room"],
      icon: (
        ...
        <div className="text-center mt-16">
          <div className="card p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              I have worked on many more projects across different technologies and domains. 
