        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="card p-8 bg-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                className="flex items-center px-8 py-4 bg-white text-blue-600 font-bold rounded-full text-lg shadow-md border-2 border-white hover:bg-blue-600 hover:text-white transition"
                onClick={handleSend}
              >
