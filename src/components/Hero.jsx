...
import profileImg from '../assets/IMG_2739.jpg'
            ...
            <div className="w-full flex justify-center items-center z-10">
              <div className="max-w-xl w-full bg-white border border-gray-200 rounded-2xl shadow-xl flex flex-col md:flex-row items-center p-8 gap-8">
                ...
                <div className="flex-1 flex flex-col justify-center">
                  ...
                  <p className="text-lg text-primary-600 font-semibold mb-2">Java Developer</p>
                  <div className="flex items-center gap-4 mt-2">
                    <a href="mailto:savanirajdeep17@gmail.com" className="text-gray-400 hover:text-primary-600 transition">
